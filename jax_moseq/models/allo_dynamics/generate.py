...
def generate_next_state(seed, z, h, v, delta_h, sigma_h, delta_v, sigma_v, pi):
    """
    ...
    dh = jr.normal(seed, (1,)) * sigma_h[z] + delta_h[z]
    dv = jr.normal(seed, (2,)) * sigma_v[z] + delta_v[z]
...
def generate_states(seed, pi, delta_h, sigma_h, delta_v, sigma_v, 
                    n_steps, init_state=None):
    """
    ...
    def _generate_next_state(carry, seed):
        z, h, v = carry
        z, h, v = generate_next_state(seed, z, h, v, delta_h, sigma_h, delta_v, sigma_v, pi)
        return (z, h, v), (z, h, v)
